...
namespace Faker
{
    public static class Company
    {
        ...
        {
            return new[] { "Inc and Sons", "LLC", "Group" }.Random();
        }
        ...
        {
            return String.Join(" ", new[] { _buzzwords1.Random(), _buzzwords2.Random(), _buzzwords3.Random() });
        }
        ...
        private static readonly IEnumerable<Func<string>> _nameFormats = new List<Func<string>>
        {
            ...
            () => string.Format("{0}, {1} and {2}", Faker.Name.Last(), Faker.Name.Last(), Faker.Name.Last()),
        };
